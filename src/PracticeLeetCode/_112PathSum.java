...
public class _112PathSum {
	...
	public static void main(String[] args) {
		...
		System.out.println(hasPathSum(tn, 1));
	}
	...
	public static boolean hasPathSum2(TreeNode root,int currSum, int sum) {
		if(root == null)
		{
			return false;
		}
		...
		return hasPathSum2(root.left, currSum + root.val, sum) || hasPathSum2(root.right, currSum + root.val, sum);
	}
